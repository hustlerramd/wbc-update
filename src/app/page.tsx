...
const WbcLink = dynamic(() => import("@/modules/core/components/WbcLink"), { ssr: false });
const WbcImage = dynamic(() => import("@/modules/core/components/WbcImage"), { ssr: false });
const Arrow = dynamic(() => import("@/modules/core/components//WbcSvg/Arrow"), { ssr: false });
						...
						<div className="flex flex-wrap -m-4">
							<div className="p-4 sm:w-1/2 xl:w-1/4 md:w-1/2 w-full">
								<div className="h-full p-6 rounded-lg bg-gray-50 flex flex-col relative overflow-hidden z-10">
									...
									<WbcLink href="/awards">
										<span className="cursor-pointer flex items-center mt-auto text-white bg-brand-pink border-0 py-2 px-4 w-full focus:outline-none hover:bg-brand-dark-pink transition-all rounded">
											Get nominating
											<Arrow />
										</span>
									</WbcLink>
