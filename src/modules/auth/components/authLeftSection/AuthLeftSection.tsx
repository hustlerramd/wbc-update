...
const AuthLeftSection: React.FC<PureComponentType> = () => {
	...
	return (
		<div className="h-full w-full max-h-full max-w-full bg-[url('/img/authImage.png')] bg-black/20 bg-cover bg-gray-600 bg-lighter-dark-blue bg-blend-soft-light ">
			<div className="flex justify-center p-2 h-full items-end max-h-full max-w-full bg-black/20	">
